...
titleLabel=Label(window, image=background_image,compound=LEFT,text='  Inventory Management System  ', font=('times new roman',40,'bold'),bg='#FFFFF0',fg='black',anchor='w',padx=20)
...
subtitleLabel=Label(window,text='Welcome, admin! \t\t Date: 04/21/2026\t\t Time: 10:32 PM',font=('times new roman', 15),bg='#F5FFFA',fg='black')
...
employeeButton=Button(leftFrame, image=employee_icon,compound=LEFT, text=' EMPLOYEE',font=('times new roman',18,'bold'),anchor='w')
employeeButton.pack(fill=X)

supplier_icon=PhotoImage(file='supplier.png')
supplier_Button=Button(leftFrame, image=supplier_icon,compound=LEFT, text=' SUPPLIER',font=('times new roman',18,'bold'),anchor='w')
supplier_Button.pack(fill=X)

category_icon=PhotoImage(file='category.png')
category_Button=Button(leftFrame, image=category_icon,compound=LEFT, text=' CATEGORY',font=('times new roman',18,'bold'),anchor='w')
category_Button.pack(fill=X)

product_icon=PhotoImage(file='product.png')
product_Button=Button(leftFrame, image=product_icon,compound=LEFT, text=' PRODUCT',font=('times new roman',18,'bold'),anchor='w')
product_Button.pack(fill=X)

sales_icon=PhotoImage(file='sales.png')
sales_Button=Button(leftFrame, image=sales_icon,compound=LEFT, text=' SALES',font=('times new roman',18,'bold'),anchor='w')
sales_Button.pack(fill=X)

exit_icon=PhotoImage(file='exit.png')
exit_Button=Button(leftFrame, image=exit_icon,compound=LEFT, text=' EXIT',font=('times new roman',18,'bold'),anchor='w')
...
totalEmp_icon_label = Label(emp_frame, text = 'TOTAL EMPLOYEES', bg='#F8E57D', fg='black',font=('times new roman',15,'bold'))
totalEmp_icon_label.pack()
...
totalSupplier_icon_label = Label(supplier_frame, text = 'TOTAL SUPPLIERS', bg='#bca89f', fg='black',font=('times new roman',15,'bold'))
totalSupplier_icon_label.pack()

totalSupplier_count_label = Label(supplier_frame, text = '0', bg='#bca89f', fg='black',font=('times new roman',30,'bold'))
...
totalCategory_icon_label = Label(category_frame, text = 'TOTAL CATEGORIES', bg='#9DC183', fg='black',font=('times new roman',15,'bold'))
totalCategory_icon_label.pack()

totalCategory_count_label = Label(category_frame, text = '0', bg='#9DC183', fg='black',font=('times new roman',30,'bold'))
...
totalProduct_icon_label = Label(product_frame, text = 'TOTAL PRODUCTS', bg='#BDE1CC', fg='black',font=('times new roman',15,'bold'))
totalProduct_icon_label.pack()

totalProduct_count_label = Label(product_frame, text = '0', bg='#BDE1CC', fg='black',font=('times new roman',30,'bold'))
...
totalSales_icon_label = Label(sales_frame, text = 'TOTAL SALES', bg='#EBF3EE', fg='black',font=('times new roman',15,'bold'))
totalSales_icon_label.pack()
